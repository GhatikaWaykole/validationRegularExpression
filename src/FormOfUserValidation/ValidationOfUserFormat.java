...
public class ValidationOfUserFormat {
   ...
   String regx = "^[A-Z]{1}[a-z]{2,}\\s[A-Z]{1}[a-z]{2,}";//validation of regex word have first name beginig with capital and white space in the last name
    String regex = "^[A-Za-z0-9.]+@[a-z.]+[a-z]$";         //validation the name of the word
    String reegex = "^[0-9]{2}\\s[0-9]{10}$";              //number of the words the validation
    String numberregex = "^(?=.*[A-Z])(?=.*[0-9])(?=.*[@#$%^-+=()]){1}[a-zA-Z0-9]{8,}";
    ...
    public void nameValidation(String name) {
        ...
        //create method validation to the number
